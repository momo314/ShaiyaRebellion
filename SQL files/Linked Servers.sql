/* Add server link, and TEST username */
IF NOT EXISTS (SELECT [name] FROM master.dbo.syslogins WHERE name = 'TEST')
BEGIN
	EXEC sp_addlogin 'TEST', 'TEST', 'PS_GameDefs';
END	
...
BEGIN
	...
	EXEC sp_addlinkedsrvlogin 'game','false',null,'TEST','TEST';
END
...
BEGIN
	...
	EXEC sp_addlinkedsrvlogin 'PS_DEFINEDB','false',null,'TEST','TEST';
END
...
BEGIN
	...
	EXEC sp_addlinkedsrvlogin 'PS_NCASH','false',null,'TEST','TEST';
END
...
BEGIN
	...
	EXEC sp_addlinkedsrvlogin 'PS_USERDB','false',null,'TEST','TEST';
END
...
BEGIN
	...
	EXEC sp_addlinkedsrvlogin 'PS_GAMEDB01','false',null,'TEST','TEST';
END
...
BEGIN
	...
	EXEC sp_addlinkedsrvlogin 'PS_USERDB01','false',null,'TEST','TEST';
END
